...
#' @slot interpret.gradients Gradients for deconvolution DL model 
#'   interpretation. It is a list of either one or two elements: gradients of 
#'   either the loss function or the predicted class with respect to the input
#'   variables. These gradients can be interpreted as to which extent the 
#'   model is using these variables to predict each cell type proportions. They 
#'   are calculated only using pure mixed transcriptional profiles. 
#'    
