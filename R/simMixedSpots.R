...
#'   \code{min.zero.prop}), respectively. By default, 40% of the simulated
#'   proportions will follow a Dirichlet distribution, 30% will consist of only
#'   one cell type, and 30% will have a specified number of different cell
#'   types.
